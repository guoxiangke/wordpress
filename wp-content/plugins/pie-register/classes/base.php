		...
		if(trim($desmiss_notice) != "")
		{
			...
			<script tyle="text/javascript">
                ...
                piereg(document).ready(function(){
					...
					{
						var dismiss_notice = '<div class="error updated" id="pie_dismiss_error"><a style="float:right;cursor:pointer;" id="pie_dismiss_close_btn">X</a><p><?php echo $desmiss_notice; ?></p></div>';
